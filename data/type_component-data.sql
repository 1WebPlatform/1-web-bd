INSERT INTO handbook.type_component ("name", description, active) VALUES('table', 'Таблица', true);
INSERT INTO handbook.type_component ("name", description, active) VALUES('button', 'Кнопка', true);
