...
INSERT INTO config.component ("name", description, css, params, "schema", "event", id_right, id_type, id_parent) VALUES('Удалить', 'Кнопка удалить проект', NULL, '{"title": "Удалить проект", "icons":"delete.svg"}', NULL, '{"click":[{"fun":"open_message","params":{"id":{"value":6}}}]}', NULL, 2, 1);
