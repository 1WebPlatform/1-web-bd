...
INSERT INTO "tec"."error" ("name", "description", "status") VALUES
	...
	('Ошибка уникальности', 'Указанное имя типа параметра уже занято', '404');
/** DATA bd */
...
/** Start Fucntion */
select * from tec.type_params_save(_name := 'test', _description :='test', _active:=false);
select * from tec.type_params_get();
select * from tec.type_params_get_id(1);
select * from tec.type_params_check_name(_name := 'test');
/** Start Fucntion */